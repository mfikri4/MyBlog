...
<head>
    ...
    <!-- Font -->
    <link href="https://fonts.googleaplis.com/css?family=Roboto:300,400,500" rel="stylesheet">
    ...
    <header>
        ...
        <div class="bottom-area">
            ...
            <ul class="main-menu visible-on-click" id="main-menu">
                @php
                    $data['mainmenu']       = DB::table('mainmenus')->where('status', 1)->
                    where('parent', 0)->orderBy('order', 'asc')->get();
                @endphp
                @foreach($data['mainmenu'] as $menu)

                @php
                    $data['mainmenu2']      = DB::table('mainmenus')->where('status', 1)->
                    ...
                    <div class="sidebar-area">
                        <div class="sidebar-section src-area">
                            <form action="{{ url('search') }}" method="GET">
                                ...
                                <button class="src-button" type="submit"><i class="ion-ios-search-strong"></i></button>
                            </form>
                        </div>
        ...
        <div class="container">
            ...
            <div class="col-sm-6">
                <div class="footer-section">
                    <Bimbingan class="copyright">Bimbingan Karir | &copy; 2021. All right reserved</p>
                </div><!-- footer-section -->
