...
<div class="main-slider">
    <div id="slider">
            ...
            <div class="ls-slide" data-ls="bgsize:cover; bgposition:50% 50%; duration:4000; transition2d:104; kenburnsscale:1.00;">
                ...
                <div class="slider-content ls-1" style="top:60%; left-30%;" data-ls="offsentyin:100%; offsetxout:-50%; durationin:800; delayin:100; durationout:400; parallaxlevel:0;">
...
<div class="single-post">
    <div class="image-wrapper"><img src="{{ url($headline->thumbnail) }}" alt="Blog Image">
    </div>
    <div class="icons">
        <div class="left-area">
...
<div class="row">
    ...
    <div class="col-lg-6 col-md-12">
        <div class="single-post">
            ...
            <div class="icons">
                <a class="btn category-btn" href="{{ url('category/'. $posts->category->id) }}">
                    <b>{{ $posts->category->name }}</b></a>
            </div>
